...
type Role = 'hiring_manager' | 'talent' | null;
...
const SignUp = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    setIsLoading('email');
    // TODO: implement sign up with selectedRole
  ...
  const handleOAuth = async (provider: 'google' | 'github') => {
    ...
    // TODO: OAuth sign up with selectedRole
    await new Promise((r) => setTimeout(r, 1200));
    setIsLoading(null);
  };

  const rightKey = selectedRole
    ? rightContent[selectedRole]
            ...
            {step === 'role' && (
              ...
              >
                <div className="mb-8">
                  <h1 className="text-[2.2rem] leading-[1.15] font-semibold tracking-tight text-gray-950 mb-3">
                    ...
                    <em className="not-italic text-gray-400 font-light">
                      {selectedRole === 'hiring_manager' ? 'Hiring Manager' : selectedRole === 'talent' ? 'Talent' : '…'}
                    </em>
                  </h1>
                ...
                <Button
                  ...
                  onClick={goToDetails}
                  className="h-11 rounded-xl bg-gray-950 hover:bg-gray-800 text-white text-sm font-medium flex items-center gap-2 group transition-all duration-200 disabled:opacity-40"
                >
                  Continue
                  <ArrowRight
                    size={15}
            ...
            {step === 'details' && (
              ...
              >
                ...
                <div className="mb-7">
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed">
                    ...
                    <span className="text-gray-900 font-medium">
                      {selectedRole === 'hiring_manager' ? 'Hiring Manager' : 'Talent'}
                    </span>
                  </p>
                </div>
                ...
                <div className="flex flex-col gap-3 lg:hidden">
                  ...
                  <Button type="button" variant="outline" disabled={isLoading !== null} onClick={() => handleOAuth('github')} className="h-11 rounded-xl border-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center gap-2.5 transition-all">
